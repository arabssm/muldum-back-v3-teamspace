...
public class Student extends User {
    ...
    private Student(Long userId, String email, String name, UUID teamId, int grade, int classNo, int studentNo) {
    ...
    public static Student create(String email, String name, UUID teamId, int grade, int classNo, int studentNo) {
        return new Student(null, email, name, teamId, grade, classNo, studentNo);
    }

    public static Student of(Long userId, String email, String name, UUID teamId, int grade, int classNo, int studentNo) {
